...
class GoogleSerperAPIWrapper():
    ...
    def _parse_results(self, results):
        ...
        if type(results) is ClientResponseError:
            print("ClientResponseError")
    ...
    async def run(self, queries):
        ...
        for sublist in queries:
            if sublist is None:
                sublist = 'None'
            flattened_queries.append(sublist)
...
if __name__ == "__main__":
    ...
    print(asyncio.run(search.run(["Give three tips for staying healthy.", "What are the three primary colors?"])))
